...
class Episode extends \App\Entity\Episode implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Episode' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Episode' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Episode' . "\0" . 'number', '' . "\0" . 'App\\Entity\\Episode' . "\0" . 'synopsis', '' . "\0" . 'App\\Entity\\Episode' . "\0" . 'season', '' . "\0" . 'App\\Entity\\Episode' . "\0" . 'slug', '' . "\0" . 'App\\Entity\\Episode' . "\0" . 'comment'];
        }
