...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), [0 => ($this->privates['.security.expression.dc7BI6r'] ?? ($this->privates['.security.expression.dc7BI6r'] = new \Symfony\Component\ExpressionLanguage\Expression('!isGranted(\'ROLE_USER\')')))], NULL);
