...
class __TwigTemplate_9b1a1761606686b27f307af2e1b8923ac8d2bc81f129a28a671178959e1eaa37 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["actor"]) {
            // line 32
            echo "            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("actor_name", ["name" => twig_get_attribute($this->env, $this->source, $context["actor"], "name", [], "any", false, false, false, 32)]), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  163 => 42,  158 => 40,  153 => 38,  149 => 36,  142 => 34,  132 => 32,  127 => 31,  117 => 24,  110 => 20,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <ul>
        {% for actor in program.actors %}
            <li><a href=\"{{ path('actor_name', {'name': actor.name}) }}\">{{ actor.name }}</a></li>
        {% else %}
...
{% endblock %}
", "program/show.html.twig", "/home/te4g/PhpstormProjects/symfony_quest/wild-series/templates/program/show.html.twig");
    }
}
