...
class __TwigTemplate_42a4e36537251409ef2491ace6097103f8fa6cd1075d4f3b427b658196600a5c extends \Twig\Template
{
    private $source;
    private $macros = [];
   ...
   <h2>";
            // line 6
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 6), "html", null, true);
            echo " / ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["program"], "title", [], "any", false, false, false, 6), "html", null, true);
            echo " - Catégorie : ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["program"], "category", [], "any", false, false, false, 6), "name", [], "any", false, false, false, 6), "html", null, true);
            echo "</h2>
   <p>";
            // line 7
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["program"], "summary", [], "any", false, false, false, 7), "html", null, true);
            echo "</p>
  </div>
 ";
...
";
    ...
    {
        return array (  121 => 12,  114 => 10,  98 => 7,  90 => 6,  87 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "wild/category.html.twig", "/home/te4g/PhpstormProjects/symfony_quest/wild-series/templates/wild/category.html.twig");
    }
}
