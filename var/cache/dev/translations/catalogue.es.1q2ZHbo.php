...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'list.series' => 'Lista de series',
    'list.seasons' => 'Lista de estaciones',
    'list.episodes' => 'Lista de episodios',
    'list.actors' => 'Lista de actores',
    'list.comments' => 'Lista de comentarios',
    'welcome' => 'Bienvenida',
    '<h1>hello_username</h1>' => '__<h1>hello_username</h1>',
    'connect' => 'Conectar !',
    'language' => 'Elije lengua',
  ),
));
